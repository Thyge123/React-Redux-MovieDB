import {useFetchUpcomingMovieQuery } from "../store";
import MovieCard from "./movieCard";
import { useSelector } from "react-redux";

function UpcomingMoviesQuery() {     
    ...
    const {data, error, isFetching } = useFetchUpcomingMovieQuery(selectedGenre);    //kaldet vil straks hente data i et result-objekt, som vi "destructure" til data, error og isLoading
