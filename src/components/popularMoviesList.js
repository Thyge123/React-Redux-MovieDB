...
function PopularMoviesList() {      
  ...
  const {data, error, isFetching } = useFetchPopularMoviesQuery(selectedGenre);    //kaldet vil straks hente data i et result-objekt, som vi "destructure" til data, error og isLoading
